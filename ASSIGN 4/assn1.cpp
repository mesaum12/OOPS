...
class Withdraw
{
    ...
    friend void update_account_details(Withdraw &w);
...
class ACCOUNT
{
   ...
   {
        if(balance>=w.ret_withdrawal_balance())
        balance-=w.ret_withdrawal_balance();
        else
        {
            cout<<"Insufficient amount in this account\n";
        }
